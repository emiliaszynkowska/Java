...
/* Constructor
 * Takes the parameters lowerBound, higherBound, and probability
 * The appliance has a random probability of being active for each of the 24 hours of the day
 */
  public RandomVaries(int lowerBound, int higherBound, double probability) {
    this.hoursActive = 24.0 * probability;
