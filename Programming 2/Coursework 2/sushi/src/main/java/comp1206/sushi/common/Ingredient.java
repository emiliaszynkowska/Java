...
public class Ingredient extends Model implements Serializable {
	...
	public Ingredient(String name, String unit, Supplier supplier, Number restockThreshold, Number restockAmount, Number weight) {
		this.setName(name);
		this.setUnit(unit);
	...
	public Number getStock() { return this.stock; }

	public void setStock(Ingredient ingredient, Number stock) { ingredient.stock = stock; }
