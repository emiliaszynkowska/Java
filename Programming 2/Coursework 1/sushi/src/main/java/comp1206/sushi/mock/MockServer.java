...
public class MockServer implements ServerInterface {
	...
	public MockServer() {
		...
		Supplier supplier4 = addSupplier("Supplier 4",postcode4);
		Supplier supplier5 = addSupplier("Supplier 5",postcode5);
		...
		Drone drone1 = addDrone(1.0);
		drone1.setSource(new Postcode("SO12 4YU"));
		drone1.setDestination(new Postcode("SO19 5TY"));
		Drone drone2 = addDrone(2.0);
		drone2.setSource(new Postcode("SO12 4YU"));
		drone2.setDestination(new Postcode("SO19 5TY"));
		Drone drone3 = addDrone(3.0);
		drone3.setSource(new Postcode("SO12 4YU"));
		drone3.setDestination(new Postcode("SO19 5TY"));

		addUser("Emilia", new Postcode("SW18 1LQ"));
		addUser("Mat", new Postcode("SO18 2NU"));
		addUser("Ponty", new Postcode("SO11 5SB"));
	}

	public User addUser(String name, Postcode postcode) {
	...
	public Postcode addPostcode(String code) {
		Postcode mock = new Postcode(code, getRestaurantPostcode()); 
